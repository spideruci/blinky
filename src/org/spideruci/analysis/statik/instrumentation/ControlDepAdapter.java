...
import org.spideruci.analysis.statik.flow.Algorithms;
import org.spideruci.analysis.statik.flow.Graph;

import org.spideruci.analysis.statik.flow.ControlFlowAnalyzer;

public class ControlDepAdapter extends ClassNode {
  private String className;
  private ClassVisitor cv;
  private boolean debug = false;
  public ControlDepAdapter(ClassVisitor cv, String className) {
    super(Opcodes.ASM4);
